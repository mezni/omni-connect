...
│    · upgrade eligibility   │  │                                     │
│    · plan recommendation   │  │   data/crm_records.json              │
│    · offer matching        │  │   data/billing_records.json          │
│    · service request       │  │                                     │
└────────────────────────────┘  └──────────────────────────────────────┘
```
...
Synthetic data is generated by `scripts/business_data_generator.py` into `data/` as linked CRM + billing pairs with six months of invoice history each.
...
| `data/crm_records.json`, `data/billing_records.json` | Done | Synthetic customer + billing data |
